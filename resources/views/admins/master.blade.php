                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="@yield('category_active')">
                        ...
                        <ul class="nav nav-second-level collapse @yield('category_active_c1') @yield('category_active_c2') @yield('category_active_c3')">
                            ...
                            <li class="@yield('category_child_3_active')"><a href="{{route('admins.brand')}}">Brand</a></li>
                        </ul>
                    </li>
                    <li class="@yield('news_letter_active')"> 
                        <a href="{{route('admins.news_letters')}}"><i class="fa fa-pie-chart"></i> <span
                    ...
                    <li class="@yield('blog_category_active')">
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">Blog Posts</span><span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse @yield('blog_category_active_c1')">
                            <li class="@yield('blog_category_child_1_active')"><a href="{{route('admins.blog_category')}}">Category</a></li>
                            <li class="@yield('product_child_2_active')"><a href="{{route('admins.products')}}">Posts</a></li>
                            <li class="@yield('product_child_3_active')"><a href="{{route('admins.post_form')}}">Add Posts</a></li>
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle"
                                                src="{{ asset('backend_assets/img/profile.jpg') }}">
                                        </a>
                                        <div>
