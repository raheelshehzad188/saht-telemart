            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" method="post">
                        ...
                        <div class="form-group"><label class="col-lg-4 control-label">Urdu Title</label>
                            <div class="col-lg-8"><input type="text" required name="title_urdu" value="{{isset($edit->title_urdu) ? $edit->title_urdu : ""}}"  class="form-control">
                                @error('title_urdu')
                                <span class="help-block m-b-none text-danger">{{$message}}</span>
                                @enderror
                            </div>
